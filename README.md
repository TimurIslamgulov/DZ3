...
* git push - команда, позволяющая загрузить свой репозиторий на GitHUB

* git pull - команда, позволяющая стянуть репозиторий другого человека с  GitHUB

* git clone "адрес репозитория" - команда, позволяющая скачать сторонний репозиторий с GitHUB

* git pull request - запрос на внесение изменений в репозиторий другого пользователя GitHUB
...
**Хочу освоить новую специальность и в дальнейшем работать в этом направлкении**
