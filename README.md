Для выполнения второго пункта я напишу здесь: Моя мечта это написать код программы/игры которую признают и оценят, а главное будут пользоваться ей и она будет приносить пользу/радость
