...
Файл readme.md здесь поэтому карточку публикую тоже здесь.

Профессия для меня не новая, а скорее немного забытая, потому что писать программы вобщем то никогда и не бросал.
Просто с уходом в системное администрирование появились другие задачи.
Желания: восстановить свой уровень знания языка С++, С#.
Цель: либо удаленная подработка, разработка своих проектов.
