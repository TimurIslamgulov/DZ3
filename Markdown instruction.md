...
# Работа с удаленными репозитoриями.

Настраиваем совместную работу. Для этого нам нужно проделать следующие действия:
...
_**pull request**_ - это команда для предложения изменений, запрос на вливание изменений в репозиторий
